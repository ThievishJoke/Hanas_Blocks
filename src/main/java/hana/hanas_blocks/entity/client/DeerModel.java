...
//		this.head = deer.getChild("body").getChild("torso").getChild("head");
//	}
//
...
//
//		ModelPartData body = deer.addChild("body", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -4.0F, 0.0F));
//
